...
const { schemaAuthValidation,schemaEmailValidation } = require('../../schemas/authSchemas');
...
router.post('/verify', validationBody(schemaEmailValidation), asyncWrapper(authController.resendingEmail));
